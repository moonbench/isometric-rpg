...
const Viewport = (function(){
  ...
  return {
    create: function(canvas){
      ...
      viewport.center_on = function(x_offset, y_offset, z_offset){
        viewport.x_world_offset = y_offset;
        viewport.y_world_offset = x_offset;
        viewport.z_world_offset = z_offset;
      }
      ...
      viewport.map_coords_to_canvas = function(x, y){
        ...
        return [
          ...
          (coords[1]/2) + ((viewport.top_offset + viewport.height/2)/viewport.scale)+viewport.z_world_offset,
        ];
      }
