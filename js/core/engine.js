...
const Engine = (function(){
  ...
  function bind_mouse(engine){
    ...
    engine.canvas.addEventListener("mousewheel", function(event){
      if(engine.handle_mouse_wheel) engine.handle_mouse_wheel(event);
    })
    engine.canvas.addEventListener("DOMMouseScroll", function(event){
      if(engine.handle_mouse_wheel) engine.handle_mouse_wheel(event);
    })
  }
